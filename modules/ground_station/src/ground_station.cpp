...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber log_control_sub = nh.subscribe<prometheus_msgs::LogMessageControl>("/uavAutoNavigation_GanAHE/log/control", 10, log_control_cb);
    ...
    if(mission_type == 1)
    {
        ros::Subscriber landpad_det_sub = nh.subscribe<prometheus_msgs::DetectionInfo>("/uavAutoNavigation_GanAHE/object_detection/ellipse_det", 10, landpad_det_cb);
    }
