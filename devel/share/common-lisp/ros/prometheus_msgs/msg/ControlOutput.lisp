...
(cl:defmethod cl:initialize-instance :after ((m <ControlOutput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlOutput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prometheus_msgs-msg:<ControlOutput> is deprecated: use prometheus_msgs-msg:ControlOutput instead.")))
...
(cl:defmethod Thrust-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:Thrust-val is deprecated.  Use prometheus_msgs-msg:Thrust instead.")
  (Thrust m))

(cl:ensure-generic-function 'Throttle-val :lambda-list '(m))
(cl:defmethod Throttle-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:Throttle-val is deprecated.  Use prometheus_msgs-msg:Throttle instead.")
  (Throttle m))

(cl:ensure-generic-function 'u_l-val :lambda-list '(m))
(cl:defmethod u_l-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:u_l-val is deprecated.  Use prometheus_msgs-msg:u_l instead.")
  (u_l m))

(cl:ensure-generic-function 'u_d-val :lambda-list '(m))
(cl:defmethod u_d-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:u_d-val is deprecated.  Use prometheus_msgs-msg:u_d instead.")
  (u_d m))

(cl:ensure-generic-function 'NE-val :lambda-list '(m))
(cl:defmethod NE-val ((m <ControlOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_msgs-msg:NE-val is deprecated.  Use prometheus_msgs-msg:NE instead.")
  (NE m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ControlOutput>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%## 位置控制器输出： 期望推力及期望油门~%float32[3] Thrust              ## [rad]  ~%float32[3] Throttle~%~%## NE控制器的中间变量~%float32[3] u_l                 ## [0-1] 惯性系下的油门量~%float32[3] u_d                 ## [rad]~%float32[3] NE                  ## [rad]~%  ~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ControlOutput)))
  "Returns full string definition for message of type 'ControlOutput"
  (cl:format cl:nil "std_msgs/Header header~%~%## 位置控制器输出： 期望推力及期望油门~%float32[3] Thrust              ## [rad]  ~%float32[3] Throttle~%~%## NE控制器的中间变量~%float32[3] u_l                 ## [0-1] 惯性系下的油门量~%float32[3] u_d                 ## [rad]~%float32[3] NE                  ## [rad]~%  ~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
