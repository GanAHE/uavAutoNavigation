...
(cl:defclass <CollisionMap> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (cell_size
    ...
    :initform 0.0)
   (OOB_occupancy_value
    :reader OOB_occupancy_value
    :initarg :OOB_occupancy_value
    :type cl:float
    :initform 0.0)
   (OOB_component_value
    :reader OOB_component_value
    :initarg :OOB_component_value
    :type cl:integer
    :initform 0)
...
(cl:defmethod origin_transform-val ((m <CollisionMap>))
...
(cl:defmethod dimensions-val ((m <CollisionMap>))
...
(cl:defmethod cell_size-val ((m <CollisionMap>))
...
(cl:ensure-generic-function 'OOB_occupancy_value-val :lambda-list '(m))
(cl:defmethod OOB_occupancy_value-val ((m <CollisionMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdf_tools-msg:OOB_occupancy_value-val is deprecated.  Use sdf_tools-msg:OOB_occupancy_value instead.")
  (OOB_occupancy_value m))

(cl:ensure-generic-function 'OOB_component_value-val :lambda-list '(m))
(cl:defmethod OOB_component_value-val ((m <CollisionMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sdf_tools-msg:OOB_component_value-val is deprecated.  Use sdf_tools-msg:OOB_component_value instead.")
  (OOB_component_value m))

(cl:ensure-generic-function 'number_of_components-val :lambda-list '(m))
(cl:defmethod number_of_components-val ((m <CollisionMap>))
...
(cl:defmethod components_valid-val ((m <CollisionMap>))
...
(cl:defmethod initialized-val ((m <CollisionMap>))
...
(cl:defmethod data-val ((m <CollisionMap>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <CollisionMap>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'OOB_occupancy_value))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'OOB_component_value)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'OOB_component_value)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 16) (cl:slot-value msg 'OOB_component_value)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 24) (cl:slot-value msg 'OOB_component_value)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CollisionMap>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'dimensions) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'OOB_occupancy_value) (roslisp-utils:decode-single-float-bits bits)))
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'OOB_component_value)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'OOB_component_value)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) (cl:slot-value msg 'OOB_component_value)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) (cl:slot-value msg 'OOB_component_value)) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CollisionMap>)))
  ...
  "69b7e5097be57c5900575a10000bd373")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CollisionMap)))
  "Returns md5sum for a message object of type 'CollisionMap"
  "69b7e5097be57c5900575a10000bd373")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <CollisionMap>))
  ...
  (cl:list 'CollisionMap
    ...
    (cl:cons ':OOB_occupancy_value (OOB_occupancy_value msg))
    (cl:cons ':OOB_component_value (OOB_component_value msg))
