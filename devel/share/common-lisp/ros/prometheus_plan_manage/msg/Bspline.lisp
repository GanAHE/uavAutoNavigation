...
(cl:in-package prometheus_plan_manage-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Bspline>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Bspline)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name prometheus_plan_manage-msg:<Bspline> is deprecated: use prometheus_plan_manage-msg:Bspline instead.")))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_plan_manage-msg:order-val is deprecated.  Use prometheus_plan_manage-msg:order instead.")
  (order m))

(cl:ensure-generic-function 'traj_id-val :lambda-list '(m))
(cl:defmethod traj_id-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_plan_manage-msg:traj_id-val is deprecated.  Use prometheus_plan_manage-msg:traj_id instead.")
  (traj_id m))

(cl:ensure-generic-function 'knots-val :lambda-list '(m))
(cl:defmethod knots-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_plan_manage-msg:knots-val is deprecated.  Use prometheus_plan_manage-msg:knots instead.")
  (knots m))

(cl:ensure-generic-function 'pts-val :lambda-list '(m))
(cl:defmethod pts-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_plan_manage-msg:pts-val is deprecated.  Use prometheus_plan_manage-msg:pts instead.")
  (pts m))

(cl:ensure-generic-function 'start_time-val :lambda-list '(m))
(cl:defmethod start_time-val ((m <Bspline>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader prometheus_plan_manage-msg:start_time-val is deprecated.  Use prometheus_plan_manage-msg:start_time instead.")
  (start_time m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Bspline>)))
  ...
  "prometheus_plan_manage/Bspline")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Bspline)))
  "Returns string type for a message object of type 'Bspline"
  "prometheus_plan_manage/Bspline")
