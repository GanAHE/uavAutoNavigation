// Generated by gencpp from file prometheus_msgs/LogMessage.msg
// DO NOT EDIT!


#ifndef PROMETHEUS_MSGS_MESSAGE_LOGMESSAGE_H
#define PROMETHEUS_MSGS_MESSAGE_LOGMESSAGE_H
...
struct LogMessage_
{
  ...
  typedef boost::shared_ptr< ::prometheus_msgs::LogMessage_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::prometheus_msgs::LogMessage_<ContainerAllocator> const> ConstPtr;

}; // struct LogMessage_

typedef ::prometheus_msgs::LogMessage_<std::allocator<void> > LogMessage;

typedef boost::shared_ptr< ::prometheus_msgs::LogMessage > LogMessagePtr;
typedef boost::shared_ptr< ::prometheus_msgs::LogMessage const> LogMessageConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::prometheus_msgs::LogMessage_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::prometheus_msgs::LogMessage_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::prometheus_msgs::LogMessage_<ContainerAllocator1> & lhs, const ::prometheus_msgs::LogMessage_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::prometheus_msgs::LogMessage_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::prometheus_msgs::LogMessage_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::prometheus_msgs::LogMessage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::prometheus_msgs::LogMessage_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::prometheus_msgs::LogMessage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::prometheus_msgs::LogMessage_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::prometheus_msgs::LogMessage_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct DataType< ::prometheus_msgs::LogMessage_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::prometheus_msgs::LogMessage_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::prometheus_msgs::LogMessage_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::prometheus_msgs::LogMessage_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::prometheus_msgs::LogMessage_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // PROMETHEUS_MSGS_MESSAGE_LOGMESSAGE_H
