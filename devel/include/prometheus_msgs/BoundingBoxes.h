...
struct BoundingBoxes_
{
  ...
  _image_header_type image_header;
   ...
   typedef std::vector< ::prometheus_msgs::BoundingBox_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::prometheus_msgs::BoundingBox_<ContainerAllocator> >::other >  _bounding_boxes_type;
